...
export async function GET(config: RouteConfig, request: string) {
    return route({ GET: config.GET }, request);
}

export async function POST(config: RouteConfig, request: string) {
    return route({ POST: config.POST }, request);
}

export async function PATCH(config: RouteConfig, request: string) {
    return route({ PATCH: config.PATCH }, request);
}

export async function PUT(config: RouteConfig, request: string) {
    return route({ PUT: config.PUT }, request);
}
